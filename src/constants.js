...
const ARTIFACTS = [
    { name: 'BLOOD PACT', desc: 'Crit hit heals 0.2 HP', cost: 400 },
    { name: 'GLASS CANNON', desc: '+30% dmg, Max HP -2', cost: 500 },
    { name: 'ECHO CHAMBER', desc: 'Bullets ricochet off walls', cost: 550 },
    { name: 'SOUL LEECH', desc: '+0.5% crit/kill  (max 10x)', cost: 700 },
    { name: 'BERSERKER', desc: 'HP<=40%: dmg x1.5, no dash slow', cost: 750 },
    { name: 'IRON SKIN', desc: 'First 3 hits/run blocked', cost: 850 },
    { name: 'MAGNET CORE', desc: 'Infinite pickup range', cost: 1200 },
];
